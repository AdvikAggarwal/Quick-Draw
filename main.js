...
function draw()
{
    strokeWeight(10);
    stroke(0);
    if (((mouseIsPressed) && (time != 0)) && (started == "true"))
    {
...
function gotresult(error, results)
{
    ...
    {
        console.log(results[0].label + "=" + thing)
        score = score + 1;
        document.getElementById("inner_score").innerHTML = "Score : " + score;
        time = 20;
        setValues();
        background("white");
    }
...
function setValues()
{
    thing = quick_draw_data_set[Math.floor((Math.random()*quick_draw_data_set.length)+1)];
    document.getElementById("Sketch").innerHTML = "Sketch to be drawn is : " + thing;
}